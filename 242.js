"use strict";(self.webpackChunk=self.webpackChunk||[]).push([[242],{9242:(t,e,s)=>{s.r(e),s.d(e,{ChangePasswordForm:()=>S,LoginForm:()=>v,RegisterForm:()=>$,ResetPasswordForm:()=>k,VerifyEmail:()=>J,VerifyResetPassword:()=>Q});var n=s(4848),i=s(4453),r=s(1307),o=s(6540),a=s(5920),d=s(3998),c=s(888),l=s(7581);const p=l.I4.form`
  display: flex;
