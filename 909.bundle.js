...
`;var k=e(894);const w=()=>(0,r.jsx)(_,{children:Array.from({length:10}).map(((i,t)=>(0,r.jsxs)(S,{children:[(0,r.jsx)(j,{children:(0,r.jsx)(k.jt,{height:"180px"})}),(0,r.jsxs)(I,{children:[(0,r.jsx)(k.jt,{height:"1.5rem",margin:"10px 0"}),(0,r.jsx)(k.jt,{height:"1.5rem",margin:"10px 0"})]})]},`skeleton-${t}`)))}),_=p.Ay.div.attrs((()=>({className:"shelf__container"})))`
  display: flex;
...
`,S=p.Ay.div.attrs((()=>({className:"shelf__item"})))`
